...
import {
  faturaSemEquipamentoUtil,
  rotuloEquipamentoFatura,
  type ClienteFaturaEquipamentoOpt,
  type ClienteFaturaListItem,
} from '../modules/clientes'

export type { ClienteFaturaListItem }
export { rotuloEquipamentoFatura }

type EquipamentoOpt = ClienteFaturaEquipamentoOpt
