...
const SHOWCASE_IMAGES: Record<string, string> = {
  reports: '/showcase/slide-reports.svg',
  clients: '/showcase/slide-clients.svg',
  parts: '/showcase/slide-parts.svg',
  knowledge: '/showcase/slide-knowledge.svg',
  warehouse: '/showcase/slide-warehouse.svg',
  finance: '/showcase/slide-finance.svg',
}
...
type Slide = {
  ...
  title: string
  desc: string
  visual: keyof typeof SHOWCASE_IMAGES
}
    ...
    >
      ...
      <div className="ns-showcase__stage" aria-label={t?.dashboardShowcaseAria || 'Demonstração das funcionalidades'}>
        {slides.map((slide, i) => (
          ...
          >
            <img
              className="ns-showcase__image"
              src={SHOWCASE_IMAGES[slide.visual]}
              alt={slide.title}
