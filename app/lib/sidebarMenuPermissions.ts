...
export const SIDEBAR_MENU_MODULES: SidebarMenuModuleDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { buttonId: 'relatorio-especial-default', action: 'open-relatorio-especial', labelKey: 'relatorioEspecialTitle', fallbackLabel: 'Relatório de Serviços', legacyKey: 'relatorioServico' },
