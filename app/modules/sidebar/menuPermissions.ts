/** Catálogo e política de itens do menu da sidebar — tipos e funções puras, sem I/O. */

import type { UserFormState } from '../admin/userFormState'
import { USER_PERMISSION_KEYS, type UserPermissionKey } from '../admin/userPermissions'
