 ...
 * Usa cabeçalho, meta e rodapé de documentLayout + cartões, tabelas e modelos visuais.
 * Sem I/O.
 */
import {
...
import { documentPdfThemeCss, type PdfDocTheme } from './themes'
import { normalizePdfModelo, pdfModeloBodyClass } from './modelos'
