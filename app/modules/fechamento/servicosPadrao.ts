...
import { servicoCodParaExibicao } from './servicoRotulos'
...
export const SERVICO_COD_ORDEM_PADRAO = ['HTT', 'HVI', 'HVR', 'KRC', 'DFC', 'DDT', 'DDH', 'DCC']
...
export function coletarCodigosMatriz(servicos: ServicoCadastroItem[]): string[] {
  ...
  list.sort((a, b) => {
    const ia = SERVICO_COD_ORDEM_PADRAO.indexOf(a)
    const ib = SERVICO_COD_ORDEM_PADRAO.indexOf(b)
