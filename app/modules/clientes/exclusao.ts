/** Exclusão de cliente — alvo e pertença de relatórios (funções puras, sem I/O). */

import { nomesClienteCorrespondem, type RelatorioServicoMin } from '../biblioteca/relatoriosRecovery'
