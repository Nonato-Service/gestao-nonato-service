import type { RelatorioEquipamentoRef } from '../../lib/relatorioServicoEquipamentos'
import type { PecaSubstituicao } from './shared'
import { dataLocalHojeISO } from './shared'

export const RELATORIOS_ESPECIAIS_STORAGE_KEY = 'nonato-relatorios-especiais'
export { RELATORIOS_ESPECIAIS_DELETED_IDS_KEY } from './deleted'
