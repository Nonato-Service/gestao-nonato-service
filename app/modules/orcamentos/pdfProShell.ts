/** CSS + wrap HTML do PDF de orçamento profissional. Sem I/O. */
...
import { normalizePdfModelo, pdfModeloBodyClass } from '../pdf/modelos'
import { orcamentoPdfThemeCss } from '../pdf/themes'
import { buildEmpresaBlockHtml, type OrcamentoPdfEmpresa } from './empresaPdf'
